        ...
        670: t => {
            ...
            var o = function (t) {
                ...
                var r, e = Object.prototype, o = e.hasOwnProperty, i = Object.defineProperty || function (t, r, e) {
                    ...
                    u = a.asyncIterator || "@@asyncIterator", f = a.toStringTag || "@@toStringTag";
                ...
                function s(t, r, e, n) {
                    var o = r && r.prototype instanceof m ? r : m, a = Object.create(o.prototype), c = new N(n || []);
                ...
                t.wrap = s;
                var p = "suspendedStart", y = "suspendedYield", v = "executing", d = "completed", g = {};
                ...
                var L = Object.getPrototypeOf, O = L && L(L(A([])));
                ...
                return b.prototype = w, i(E, "constructor", {
                    ...
                    constructor: N, reset: function (t) {
                        if (this.prev = 0, this.next = 0, this.sent = this._sent = r, this.done = !1, this.delegate = null, this.method = "next", this.arg = r, this.tryEntries.forEach(T), !t) for (var e in this) "t" === e.charAt(0) && o.call(this, e) && !isNaN(+e.slice(1)) && (this[e] = r)
                    }, stop: function () {
                        this.done = !0;
            ...
            function o() {
                ...
                var t = {}, r = Object.prototype, e = r.hasOwnProperty,
                ...
                function s(t, r, e, n) {
                    var o = r && r.prototype instanceof y ? r : y, a = Object.create(o.prototype), c = new P(n || []);
            ...
            t.exports = {
                workerBlobURL: !0, logger: function () {
                }
            }
        }, 5: t => {
            t.exports = {
            ...
            t.exports = function (t) {
                var r = t.id, e = t.action, i = t.payload, a = void 0 === i ? {} : i, c = r;
                return void 0 === c && (c = n("Job", o), o += 1), {id: c, action: e, payload: a}
            }
        }, 936: function (t, r, e) {
            function n(t) {
                return n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
            ...
            function i() {
                ...
                function s(t, r, e, n) {
                    var i = r && r.prototype instanceof y ? r : y, a = Object.create(i.prototype), c = new P(n || []);
            ...
            var f = e(106), l = e(185).log, s = e(313), h = 0;
            t.exports = function () {
                var t = s("Scheduler", h), r = {}, e = {}, n = [];
                h += 1;
                var c = function () {
                    return Object.keys(r).length
                }, p = function () {
                    if (0 !== n.length) for (var t = Object.keys(r), o = 0; o < t.length; o += 1) if (void 0 === e[t[o]]) {
                        n[0](r[t[o]]);
                        break
                    }
                }, y = function (r, c) {
                ...
                return {
                    ...
                    }, addJob: v, terminate: d, getQueueLen: function () {
                        return n.length
                    }, getNumWorkers: c
                }
            }
            ...
            var p = e(187), y = e(549), v = e(106), d = e(185).log, g = e(313), m = e(847), b = e(581),
                w = b.defaultOptions, x = b.spawnWorker, L = b.terminateWorker, O = b.onMessage, E = b.loadImage,
                S = b.send, j = 0;
            t.exports = h(i().mark((function t() {
                var r, e, n, c, f, s, b, P, k, _, T, N, A, G, I, F, R, D, M, C, U, Y, B, z, H, K, W, J, V, Z, Q, q, X,
                    $, tt, rt, et, nt, ot, it, at = arguments;
                return i().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
                            return r = at.length > 0 && void 0 !== at[0] ? at[0] : "eng", e = at.length > 1 && void 0 !== at[1] ? at[1] : m.LSTM_ONLY, n = at.length > 2 && void 0 !== at[2] ? at[2] : {}, c = at.length > 3 && void 0 !== at[3] ? at[3] : {}, f = g("Worker", j), s = p(u(u({}, w), n)), b = s.logger, P = s.errorHandler, k = l(s, o), _ = {}, T = {}, N = "string" == typeof r ? r.split("+") : r, A = e, G = c, I = [m.DEFAULT, m.LSTM_ONLY].includes(e) && !k.legacyCore, D = new Promise((function (t, r) {
                                ...
                                var r = t.id, e = t.action, n = t.payload;
                                return new Promise((function (t, o) {
                                    d("[".concat(f, "]: Start ").concat(r, ", action=").concat(e));
                                    var i = "".concat(e, "-").concat(r);
                                    U(i, t), Y(i, o), S(C, {workerId: f, jobId: r, action: e, payload: n})
                                }))
                            }, z = function () {
                                ...
                                return B(v({
                                    id: t,
                                    action: "load",
                                    payload: {options: {lstmOnly: I, corePath: k.corePath, logging: k.logging}}
                                }))
                            }, K = function (t, r, e) {
                                return B(v({id: e, action: "FS", payload: {method: "writeFile", args: [t, r]}}))
                            }, W = function (t, r) {
                                return B(v({
                                    id: r,
                                    action: "FS",
                                ...
                                return B(v({id: r, action: "FS", payload: {method: "unlink", args: [t]}}))
                            }, V = function (t, r, e) {
                                return B(v({id: e, action: "FS", payload: {method: t, args: r}}))
                            }, Z = function () {
                                ...
                                return B(v({id: n, action: "initialize", payload: {langs: t, oem: r, config: e}}))
                            }, $ = function () {
                                ...
                                return B(v({
                                    ...
                                    payload: {params: arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}}
                                }))
                            }, rt = function () {
                                ...
                                var r = t.workerId, e = t.jobId, n = t.status, o = t.action, i = t.data,
                                    a = "".concat(o, "-").concat(e);
                                if ("resolve" === n) {
                                    d("[".concat(r, "]: Complete ").concat(e));
                                    var c = i;
                                    "recognize" === o ? c = y(i) : "getPDF" === o && (c = Array.from(u(u({}, i), {}, {length: Object.keys(i).length}))), _[a]({
                                        jobId: e,
                                        data: c
                                    })
                                } else if ("reject" === n) {
                                    ...
                                    P(i)
                                } else "progress" === n && b(u(u({}, i), {}, {userJobId: e}))
                            })), it = {
                                id: f,
                                worker: C,
                                setResolve: U,
            ...
            e(760);
            var a = e(936), c = e(311), u = e(793), f = e(5), l = e(847), s = e(711), h = e(185).setLogging;
            t.exports = function (t) {
                for (var r = 1; r < arguments.length; r++) {
                    var e = null != arguments[r] ? arguments[r] : {};
                ...
                return t
            }({languages: f, OEM: l, PSM: s, createScheduler: a, createWorker: c, setLogging: h}, u)
        }, 549: t => {
            function r(t) {
                return r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
                    return typeof t
                        ...
                        r.lines.forEach((function (e) {
                            e.words.forEach((function (o) {
                                o.symbols.forEach((function (i) {
                                    a.push(n(n({}, i), {}, {page: t, block: c, paragraph: r, line: e, word: o}))
                                })), i.push(n(n({}, o), {}, {page: t, block: c, paragraph: r, line: e}))
                            })), o.push(n(n({}, e), {}, {page: t, block: c, paragraph: r}))
                        })), e.push(n(n({}, r), {}, {page: t, block: c}))
                    })), r.push(n(n({}, c), {}, {page: t}))
                })), n(n({}, t), {}, {blocks: r, paragraphs: e, lines: o, words: i, symbols: a})
            }
        }, 129: (t, r, e) => {
            function n(t) {
                return n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
            ...
            var c = e(147).i8, u = e(341);
            t.exports = i(i({}, u), {}, {workerPath: "https://cdn.jsdelivr.net/npm/tesseract.js@v".concat(c, "/dist/worker.min.js")})
        }, 581: (t, r, e) => {
            var n = e(854), o = e(676), i = e(100), a = e(202), c = e(772), u = e(931);
            ...
            function e() {
                ...
                var t = {}, n = Object.prototype, o = n.hasOwnProperty,
                    i = Object.defineProperty || function (t, r, e) {
                        t[r] = e.value
                    }, a = "function" == typeof Symbol ? Symbol : {}, c = a.iterator || "@@iterator",
                    u = a.asyncIterator || "@@asyncIterator", f = a.toStringTag || "@@toStringTag";
            ...
            t.exports = function (t) {
                ...
                if (Blob && URL && n) {
                    var o = new Blob(['importScripts("'.concat(e, '");')], {type: "application/javascript"});
